<?php
/**
 * @link http://www.crazyacking.com/
 * @copyright Copyright (c) 2016 crazyacking
 * @license http://www.github.com/crazyacking/shell/LICENSE/
 */
namespace crazyacking\helpers;
use crazycking;
use crazyacking\base\Arrayable;
use crazyacking\base\InvalidParamException;
/**
 * BaseArrayHelper provides concrete implementation for [[ArrayHelper]].
 *
 * Do not use BaseArrayHelper. Use [[ArrayHelper]] instead.
 *
 * @author Shanbiao Jiang <crazyacking@gmail.com>
 * @since 2.0
 */
